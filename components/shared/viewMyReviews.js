...
import { TouchableOpacity, ActivityIndicator, Text, Image, RefreshControl, View, Alert, ToastAndroid, FlatList, SafeAreaView } from 'react-native';
...
//deleting clicked review from flatList, passing parameter through FlatList 
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <View style={styles.fields}>
                ...
                <Image
                  source={{
                    uri: 'http://10.0.2.2:3333/api/1.0.0/location/' +
                ...
                <View style={styles.fixToText}>
                  <TouchableOpacity
                    ...
                    onPress={() => navigator.navigate('update_review', {
                  ...
                  <TouchableOpacity
                    style={styles.buttonStyle}
                    onPress={() => navigator.navigate('addReviewPic', {
                      review_id: item.review.review_id,
                      location_id: item.location.location_id
                    })}>
